...
const FAQ = () => {
    ...
    return (
        <div className='faq-container'>
            ...
            <FaqContainer
                title={'¿Cómo creo una cuenta de Estudiante?'}
                description={
                    <p>
            ...
            <FaqContainer
                title={"¿Cuáles son los requisitos necesarios para publicar ofertas laborales o pasantias?"}
                description={
                    <p>
            ...
            <FaqContainer
                title={"¿Cuáles son los requisitos académicos necesarios para postularse a una pasantía o oferta laboral?"}
                description={
                    <p>
                        <h4>Trabajo en relación de dependencia</h4>
