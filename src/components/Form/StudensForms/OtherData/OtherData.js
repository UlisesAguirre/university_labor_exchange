        ...
        (curriculumError ?
          ...
          <>
            ...
            <div className={`otherData-form ${theme}`}>
              ...
              <Curriculum userId={userId} name={form.name} lastName={form.lastName} setcurriculum={setcurriculum} setErrors={setErrors} errors={errors} setCurriculumError={setCurriculumError} />
